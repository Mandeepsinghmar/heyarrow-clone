...
const FacebookSpecificCampaign = (props) => {
...
FacebookSpecificCampaign.propTypes = {
  campaignFormData: PropTypes.objectOf(PropTypes.any),
};

FacebookSpecificCampaign.defaultProps = {
  campaignFormData: {},
};
...
export default connect(mapStateToProps, null)(FacebookSpecificCampaign);
